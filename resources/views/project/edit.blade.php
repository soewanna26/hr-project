...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('project.update', $project->id) }}" method="POST" id="edit-form" autocomplete="off">
                @csrf
                @method('PUT')
                <div class="md-form">
                ...
                <div class="md-form">
                    ...
                    <textarea name="description" class="md-textarea form-control p-3" rows="5">{{ $project->description }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="files[]" class="form-control p-1" id="files" multiple
